...
class Foo {
    ...
    protected val protected2Property : MyClass = object : MyClass() {fun visible() {}}

    public val public2Property : MyClass = object : MyClass() {fun visible() {}}
    ...
    fun testProperties() {
      ...
      protected2Property.<!UNRESOLVED_REFERENCE!>visible<!>()
      public2Property.<!UNRESOLVED_REFERENCE!>visible<!>()
